...
class MYNET(Net):
    ...
    def set_module_for_audio(self, args):
        ...
        # Add all dataset-specific extractors for multi-dataset support
        # FreeSound extractors (44100 samples)
        ...
        # NSynth extractors (64000 samples)
        ...
        # LibriSpeech extractors (32000 samples)
